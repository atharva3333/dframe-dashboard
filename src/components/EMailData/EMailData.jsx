...
const BrowserData = () => {
  return (
    <div className="w-[100vw] p-0 m-0 h-[100vh]">
        ...
        <h1 className='font-medium text-4xl p-6'>Email Data</h1>
        <div className="bg-white ml-[8vw] h-[16vh] w-[64vw] text-center rounded-2xl">           
              <p className='text-[3.4vh] pt-5 font-semibold'> Email Data Policy</p>
        ...
        <div className='flex flex-row'>
              <p className='px-[7vw] text-[2.65vh]'>This is your data from this _______ Email, which will be analyzed</p>  <p className='px-24 text-red-500 text-2xl'>X</p> 
        </div>
        <div className='flex flex-row'>
              <p className='px-[7vw] text-[2.65vh]'>This is your data from this _______ Email, which will be analyzed</p>  <p className='px-24 text-red-500 text-2xl'>X</p> 
        </div>

...
const data1 = [
  { name: "TopSites", value: 300 },
  { name: "TopSites", value: 200 },
  { name: "TopSites", value: 150 },
  { name: "TopSites", value: 100 }
];
...
const TopSiteVisited = () => {
  ...
  return (
    <div className="w-[100vw] p-0 m-0 h-[100vh]">
        ...
        <h1 className='font-medium text-4xl p-6'>Top Sites Visited</h1>
        <ResponsiveContainer className='ml-[22vw] mt-[-4vh]' width="42%" height="60%">
        <PieChart width={400} height={250} className="pie">
            <Pie data={data} cx={300} cy={186} labelLine={false} label={renderCustomizedLabel} outerRadius="30vw" fill="#8884d8" dataKey="value">
